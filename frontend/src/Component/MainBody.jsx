          ...
          <div className="row pt-5 pb-5">
            <div className="col-sm-12 col-md-5 ">
              ...
              <p className="h-desc">
                ...
                individual's needs, abilities and goals with current or future
                opportunities in the organisation. It is the process through
                which the action plans are implemented.
              </p>
              <br />
              <br />
              ...
              <div className="">
                ...
                <NavLink to="/devtypes">
                  <button
                    type="button md-mr-5"
                    className="btn btn-danger  h-btn"
                    id="h-start"
                    onClick=""
                  >
                    Let's Start
